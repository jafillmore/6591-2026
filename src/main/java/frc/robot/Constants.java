...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kMaxAngularSpeed = 3.5  * Math.PI; // radians per second
...
public static final class VisionConstants {
    public static final double kPAimingController = 0.01;
  ...
  public static final class PoseCamera1 {
    ...
    // XYZ
    private static final double xLocation = Units.inchesToMeters(-9.0);
  ...
  public static final class PoseCamera2 {
    ...
    // XYZ
    private static final double xLocation = Units.inchesToMeters(4.0);
